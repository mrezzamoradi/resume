const resume_python = {
    ...
    experience: [
        ...
        },
        {
            ...
            items: [
                ...
                // "Working with both SQL and No-SQL databases.",
                ...
                "Developed a web dashboard to control and monitor the assistant. It boosted troubleshooting process by generating more comprehensible data.",
                ...
                "Authored scripts to automate DB and storage backup mechanisms.",
    ...
    hard_skills: [
        {name: "Python", level: 4},
        {name: "Async&nbsp;Programming", level: 3},
        {name: "TDD", level: 4},
        {name: "OOP", level: 3},
        {name: "Django", level: 3},
        ...
        {name: "SQLAlchemy", level: 2},
        {name: "System&nbsp;Administration", level: 1},
        {name: "Shell&nbsp;Scripting", level: 1},
        {name: "Git", level: 3},
        {name: "HTML", level: 3},
        {name: "CSS", level: 3},
        {name: "JS/JQuery", level: 2},
        {name: "Docker", level: 3},
        {name: "Scrum", level: 2},
...
const resume_all = {
    ...
    summary: "Passionate Python developer with 2+ years of experience in web backend, API design, and async programming. " +
        "With comprehensive knowledge about Network, DBs, Docker, Gitlab CI/CD, monolithic and microservices architectures, " +
